...
|---|---|----|-----|-----|----|---|
| 581951 | Blocker | 1000 | Verification | JEAN.LC.WANG 王儷臻 | 2 | [JIRA] (程式編輯) [IABGVOC-2091] W3A 專案編譯時出現多筆 C0115 Overma |
...
| 561097 | Critical | 600 | Verification | ORLANDO.LAN 藍順騰 | 124 | [JIRA] (程式編輯) [IABGVOC-1463] 变量类型支持ANY变量 |
| 578942 | Major | 400 | Review | ORLANDO.LAN 藍順騰 | 21 | [JIRA] (程式編輯) [IABGVOC-1952] 新增变数的型态可以考虑参考CODESYS :只要搜寻 |
...
| 561259 | Major | 400 | Review | MICHAEL.JN.TSAI 蔡秉昌 | 121 | [JIRA] (運動控制) [IABGVOC-1476] DIADesigner软件评估能否增加：当修改轴设置 |
...
**Issue**：共 27 筆（開放 15 / 已關閉 12）
**Requirement**：共 35 筆（開放 31 / 已關閉 4）

### 5.1 特別關注 Issue（依 FMEA 排序）
...
| 527679 | step_control | Critical | 600 | Closed | ORLANDO.LAN 藍順騰 | [JIRA] (模組編輯) [IABGVOC-1061] VAR RETAIN/RETAIN_M 問題反饋 ( |
...
### 5.2 特別關注 Requirement（依 FMEA 排序）
...
| 527019 | step_control | Critical | 600 | In Progress | JEAN.LC.WANG 王儷臻 | [JIRA] (模組編輯) [IABGVOC-1012] R1扩展模组映射变量无法关联Byte/Word等数据 |
| 561097 | step_control | Critical | 600 | Verification | ORLANDO.LAN 藍順騰 | [JIRA] (程式編輯) [IABGVOC-1463] 变量类型支持ANY变量 |
| 578942 | dgc_fae | Major | 400 | Review | ORLANDO.LAN 藍順騰 | [JIRA] (程式編輯) [IABGVOC-1952] 新增变数的型态可以考虑参考CODESYS :只要搜寻 |
...
| 561761 | step_control | Major | 400 | In Progress | ORLANDO.LAN 藍順騰 | [JIRA] (程式編輯) [IABGVOC-1487] 数组范围可以设定便属性为常量的变量ARRAY [0. |
...
| 581078 | dgc_fae | Major | 240 | Review | LEANN.TING 丁寧 | [JIRA] (輔助工具) [IABGVOC-2041] 万年历功能 |
| 579939 | 手順 | Major | 240 | Review | STEWARD.LU 呂名峰 | [JIRA] (程式編輯) [IABGVOC-2037] ENUM 變數監控賦值功能優化 |
| 579933 | dgc_fae | Major | 240 | Review | JACKY.TU 杜寧 | [JIRA] (運動控制) [IABGVOC-1996] 轴参数画面配置画面参考AX8配置第三方电机（比亚迪） |
...
| 579090 | step_control | Major | 240 | Review | HARVEY.XIE 謝孟軒 | [JIRA] (程式編輯) [IABGVOC-1984] 枚舉類型的變數 Show Hint 能顯示出成員名稱 |
...
| 579894 | 手順 | Major | 160 | Review | ELVIS.CT.CHANG 張錦宗 | [JIRA] (程式編輯) [IABGVOC-2034] 梯形圖接點、輸出線圈右鍵選單內容優化 |
...
|---|---|----|-----|-----|----|------|---|
| 581951 | Blocker | 1000 | Verification | JEAN.LC.WANG 王儷臻 | 2 | IA Internal-IMSBU | [JIRA] (程式編輯) [IABGVOC-2091] W3A 專案編譯時出現多筆 C0115 Overma |
| 579102 | Critical | 600 | Verification | KAKA.WU 吳思言 | 21 | IA Internal-SC | [JIRA] (程式編輯) [IABGVOC-2013] 及時刷新 LOG 狀態下關閉頁籤，在线仿真發生例外 |
| 578889 | Critical | 600 | Review | Unassigned | 22 | DGC-China | [JIRA] (硬體配置) [IABGVOC-1955] 重新安裝 COMMGR 後，每次在专案按了连线就会跳 |
| 574365 | Critical | 600 | Verification | UNI.CHEN 陳軍宇 | 50 | IA Internal-SC | [JIRA] (程式編輯) [IABGVOC-1829] ST Pou 在線監控程序時出現 "未知序列錯誤" |
| 572378 | Critical | 600 | In Progress | MIAO.CHEN 陳炫妙 | 57 | IA Internal-SC | [JIRA] (程式編輯) [IABGVOC-1768] 变量表初值设定错误后无法编辑 |
| 572377 | Critical | 600 | In Progress | MIAO.CHEN 陳炫妙 | 57 | IA Internal-SC | [JIRA] (程式編輯) [IABGVOC-1769] ARRAY[*] OF ARRAY[*] OF 2維 |
| 563431 | Critical | 600 | Review | Unassigned | 112 | IA Internal-SC | [JIRA] (調適) [IABGVOC-1532] 示波器保存的波形重新打开后发现显示的波形和我们点击的不符 |
| 562353 | Critical | 600 | Review | Unassigned | 117 | IA Internal-SC | [JIRA] (調適) [IABGVOC-1506] 示波器由A专案保存，开启B专案后打开示波器后部分变量无法 |
| 538366 | Critical | 600 | Review | UNI.CHEN 陳軍宇 | 259 | IA Internal-SC | [JIRA] (程式編輯) [IABGVOC-2032] Ladder Expression 輸出接點狀態顯示 |
| 505913 | Critical | 600 | Review | PINGCHIN.WANG 王昞清 | 413 | IA Internal-CoreTech | [JIRA][efficacy](程式編輯) [IABGVOC-785] DIADesigner SP4 發生 |
| 486433 | Critical | 600 | Review | STEWARD.LU 呂名峰 | 491 | DGC-China | [JIRA] (調適) [IABGVOC-513] 增加在线时，多个变量修改状态，可以同时写入PLC功能 -  |
| 578888 | Critical | 240 | Review | Unassigned | 22 | DGC-China | [JIRA] (網路配置) [IABGVOC-1958] EtherCAT 插入設備時彈出例外視窗 |

### B. 老化 Issue 完整清單（>180 天，共 15 筆）

| ID | 嚴重性 | FMEA | State | Owner | 開放天數 | Region | 摘要 |
|---|---|----|-----|-----|----|------|---|
| 383486 | Major | 80 | Verification | LUCIAN.LS.OUYANG 歐陽龍祥 | 905 | IA Internal-CoreTech | [JIRA] (調適) [IABGVOC-177] Issue 383486 - 在online monito |
| 386302 | Major | 120 | In Progress | LUCIAN.LS.OUYANG 歐陽龍祥 | 894 | IA Internal-CoreTech | [JIRA] (程式編輯) [IABGVOC-183] Issue 386302 - DIADesigner庫 |
| 410331 | Minor | 120 | Review | MIAO.CHEN 陳炫妙 | 796 | IA Internal-CoreTech | [JIRA](程式編輯) [IABGVOC-193] Issue 410331 - 热键：跳转到变量表，能否增 |
| 412810 | Major | 240 | Review | HARVEY.XIE 謝孟軒 | 786 | IA Internal-CoreTech | [JIRA] (程式編輯) [IABGVOC-196] CORNER-3323 - ST语法中TO_TIME( |
| 416557 | Major | 240 | Review | STEWARD.LU 呂名峰 | 770 | IA Internal-CoreTech | [JIRA] (線上斷線) [IABGVOC-197] Issue 416557 - 在线时拔掉电脑与W3A的 |
| 416915 | Major | 360 | Review | ELVIS.CT.CHANG 張錦宗 | 769 | IA Internal-CoreTech | [JIRA](程式編輯) [IABGVOC-198] Issue 416915 - FB功能块，调整其内部变量 |
| 425835 | Major | 240 | Review | LEANN.TING 丁寧 | 734 | IA Internal-CoreTech | [JIRA] (程式編輯) [IABGVOC-189] Issue 425835 - 测试打断点时，出现报错提 |
| 466614 | Major | 400 | In Progress | STEWARD.LU 呂名峰 | 568 | DGC-China | [JIRA] (程式編輯) [IABGVOC-2017] In the Ladder program unit |
| 469965 | Minor | 80 | Verification | LEANN.TING 丁寧 | 554 | DGC-China | [JIRA] (專案管理) [IABGVOC-186] Issue 407138 - 软件下载界面：勾选下载后 |
| 486433 | Critical | 600 | Review | STEWARD.LU 呂名峰 | 491 | DGC-China | [JIRA] (調適) [IABGVOC-513] 增加在线时，多个变量修改状态，可以同时写入PLC功能 -  |
| 505913 | Critical | 600 | Review | PINGCHIN.WANG 王昞清 | 413 | IA Internal-CoreTech | [JIRA][efficacy](程式編輯) [IABGVOC-785] DIADesigner SP4 發生 |
| 522471 | Major | 64 | In Progress | XAVIERA.FAN 范珮欣 | 342 | IA Internal-SC | [JIRA] (程式編輯) [IABGVOC-977] 与设备断线后软体还显示在线状态 |
| 528538 | Major | 240 | Verification | ARCHIE.YANG 楊浩群 | 306 | DGC-China | [JIRA] (程式編輯) [IABGVOC-1054] DIADesigner软件上传W3A程序及配置无法上 |
| 528531 | Major | 240 | In Progress | LUCIAN.LS.OUYANG 歐陽龍祥 | 306 | DGC-China | [JIRA] (程式編輯) [IABGVOC-1058] 功能块实例必须自己手敲，才会确认，不智能，应该可以自 |
| 538366 | Critical | 600 | Review | UNI.CHEN 陳軍宇 | 259 | IA Internal-SC | [JIRA] (程式編輯) [IABGVOC-2032] Ladder Expression 輸出接點狀態顯示 |
